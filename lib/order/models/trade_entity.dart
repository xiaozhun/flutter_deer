class Trade {
  ...
  factory Trade.fromJson(Map<String, dynamic> json) {
    return Trade(
      ...
      tradeprice: json['tradeprice'] as double,
      tradenumber: json['tradenumber'] as int,
      ...
      profitrate: json['profitrate'] as double,
      zhiying: json['zhiying'] as double,
      zhisun: json['zhisun'] as double,
      mark: json['mark'] as String,
      clientId: json['clientId'] as String,
      isTruesale: json['isTruesale'] as int,
    );
  }
